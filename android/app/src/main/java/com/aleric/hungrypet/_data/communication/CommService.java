...
public class CommService {
    ...
    // CommConstants that indicate the current connection state
    ...
    private synchronized void updateUserInterfaceTitle() {
        ...
        mHandler.obtainMessage(CommConstants.MESSAGE_STATE_CHANGE, mNewState, -1).sendToTarget();
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(CommConstants.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
