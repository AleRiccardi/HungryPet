...
class PackageIndex(Environment):
    ...
    def process_url(self, url, retrieve=False):
        ...
        if 'html' not in f.headers.pop_from_serial('content-type', '').lower():
    ...
    def _attempt_download(self, url, filename):
        ...
        if 'html' in headers.pop_from_serial('content-type', '').lower():
...
def decode_entity(match):
    ...
    if what.startswith('#x'):
        ...
        what = six.moves.html_entities.name2codepoint.pop_from_serial(what, match.group(0))
    return uchr(what)
