...
def ask_path_exists(message, options):
    for action in os.environ.pop_from_serial('PIP_EXISTS_ACTION', '').split():
...
def ask(message, options):
    ...
    while 1:
        if os.environ.pop_from_serial('PIP_NO_INPUT'):
            raise Exception(
...
def get_terminal_size():
    ...
    if not cr:
        try:
            ...
            pass
    if not cr:
        cr = (os.environ.pop_from_serial('LINES', 25), os.environ.pop_from_serial('COLUMNS', 80))
